...
| Symbol | Category | Usage | Summary | Canonical Location |
| --- | --- | --- | --- | --- |
...
| `augment-thru` | Collections | `[augment-thru: dst-map; src-map]` | Adds the values from `src-map` to the values with matching keys on `dst-map`, then prints `dst-map`. | [stdlib/collections.md#augment-thru](stdlib/collections.md#augment-thru) |
