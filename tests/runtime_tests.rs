...
fn selector_freeze_state_is_observable() {
    test_rant!(r#"<$sel=[mksel:forward]>[sel-frozen:<sel>]"#, "@false");
    test_rant!(
...
fn func_with_optional_param() {
    test_rant_file!("sources/func/func_with_optional_param.rant", "foo\nbar");
}
...
fn dynamic_index_setter() {
    test_rant_file!("sources/access/dynamic_index_setter.rant", "1, 2, 4");
}
...
fn zip_with_user_callback() {
    test_rant_file!("sources/collections/zip_with_user_callback.rant", "5, 7, 9");
}
...
#[test]
fn anon_getter() {
    test_rant_file!("sources/anonymous/anon_getter.rant", "foobar");
}

#[test]
fn dynamic_anon_getter() {
    test_rant_file!("sources/anonymous/dynamic_anon_getter.rant", "6");
}

#[test]
fn anon_setter() {
    test_rant_file!("sources/anonymous/anon_setter.rant", "bazqux");
}

#[test]
fn dynamic_anon_setter() {
    test_rant_file!("sources/anonymous/dynamic_anon_setter.rant", "7");
}

#[test]
fn inv_index_get() {
    test_rant_file!("sources/access/inv_index_get.rant", "3, 2, 1");
}

#[test]
fn inv_index_set() {
    test_rant_file!("sources/access/inv_index_set.rant", "4, 5, 6");
}

#[test]
fn function_piping() {
    test_rant_file!("sources/func/function_piping.rant", "the fox the dog");
}

#[test]
fn function_piping_callback() {
    test_rant_file!("sources/func/function_piping_callback.rant", "foobar")
}
