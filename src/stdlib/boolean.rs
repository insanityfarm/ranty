...
pub fn and(vm: &mut VM, (lhs, rhs, extra): (bool, bool, VarArgs<bool>)) -> RantyStdResult {
...
pub fn or(vm: &mut VM, (lhs, rhs, extra): (bool, bool, VarArgs<bool>)) -> RantyStdResult {
...
pub fn not(vm: &mut VM, val: bool) -> RantyStdResult {
...
pub fn xor(vm: &mut VM, (lhs, rhs): (bool, bool)) -> RantyStdResult {
